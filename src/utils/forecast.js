...
const forecast = (latitude, longitude, callback) => {
    const url = 'http://api.weatherstack.com/current?access_key=c4054b998d8b5e479c6ffab215e38812&query='  + latitude + ',' + longitude
...
const forecast2= (latitude, longitude, callback) => {
    const url2 = 'http://api.weatherstack.com/current?access_key=e562704299f5e9a6bb484ff07e1d8694&query='  + latitude + ',' + longitude
